<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="indexomnivox.aspx.cs" Inherits="prjWebCsAdoNet.indexomnivox" %>
    ...
    <div class="login">
        <form id="form1" runat="server" class="form">
            ...
            <div class="auto-style4">
                ...
                <div  >
                    <asp:Button ID="btnLogin" CssClass="btnLogin" runat="server" Text="Entrer" Font-Bold="True" OnClick="btnLogin_Click"  />
                 </div>
                 <div class="btnLink">
                     <asp:LinkButton ID="btnInscrire" runat="server" class="btn" Font-Bold="True" OnClick="btnInscrire_Click" >Premiere utilisation ?</asp:LinkButton>
                 </div>
                <div>
